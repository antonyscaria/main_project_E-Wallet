...
if(isset($_POST['submit']))
{
  ...
  $email="nithingeorgekanappilly@gmail.com";
  if($query)
  {
...
>
  <head>
    ...
    function MakePayement(){
        ...
        var options = {
    "key": "rzp_test_EcBpyC4R1RKKvr", // Enter the Key ID generated from the Dashboard
    "amount": amount*100, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
    "currency": "INR",
    "name":name,
    "description": "E-Wallet",
    "image": "assets/wa_app_logo.png",
    ...
    "handler": function (response){
        jQuery.ajax({
            ...
            success:function(result){
                window.location.href="rechargedone.php?amount="+amount;
                ...
                <div class="col-xxl">
                  ...
                  />
                        ...
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
                          <input type="button" name="button" class="btn btn-primary" value="Recharge" onclick="MakePayement()">
