...
{
  $email=$_POST['email'];
  $sql=mysqli_query($connection,"SELECT * FROM `personal_details` WHERE email='$email'");
...
Reset Password--->> <button onclick="window.location.href="http://localhost/Wallet_web/user/html/Passwordreset.php>Reset Password</button></div>
</center>
</body>
</html>'; 
