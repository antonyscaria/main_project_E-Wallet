...
$id=$_REQUEST['id'];
$query7 = "SELECT * FROM `user_type` WHERE user_type_id='".$id."'"; 
...
if(isset($_POST['submit']))
{
    ...
    $sql1="UPDATE `user_type` SET `user_type`='$usertype' WHERE `user_type_id`='$id'";
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" name="usertype" type="text" placeholder="Enter User Type" value="<?php echo $row4['user_type'];?>" required />
                                                    </div>
                                                </div>
                                            </div>
