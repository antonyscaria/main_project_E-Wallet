...
<html lang="en">
    <head>
        ...
        <title>Admin Dashboard | E-Wallet</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <!-- <div class="card-body"> -->
                         ...
                         <div class="breadcrumb mb-4"><p>User Bank Details</p></div>
                         <div class="breadcrumb mb-4"><p>Professional User Details</p></div>
                         <div class="breadcrumb mb-4"><p>Organization details</p></div>
                         <div class="breadcrumb mb-4"><p>Blocked Users</p></div>
                         <div class="breadcrumb mb-4"><p> Blocked Professionals</p></div>
                         <div class="breadcrumb mb-4"><p>Blocked Organizationas</p></div>
                         <div class="breadcrumb mb-4"><p>User Type</p></div>
                         <div class="breadcrumb mb-4"><p>Add User Type</p></div>
